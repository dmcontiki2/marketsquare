...
async function _renderAgency(agencyId){
  ...
  el.innerHTML= opsBar
    +'<div style="background:var(--navy,#0c1a2e);color:#fff;border-radius:14px;padding:18px 20px;margin-bottom:14px;">'
      +'<div style="font-family:Syne,sans-serif;font-weight:800;font-size:19px;">'+a.name+' <span style="font-size:11px;background:rgba(34,197,94,.15);color:#86efac;border:1px solid rgba(34,197,94,.4);border-radius:20px;padding:3px 10px;margin-left:6px;">✓ '+(a.verified?'Verified':'Pending')+' '+_agL('brand')+'</span>'+(localStorage.getItem('ms_superuser')==='1'?' <button onclick="agencyRename()" title="Rename before a demo" style="background:none;border:1px solid rgba(255,255,255,.25);color:#fff;border-radius:8px;padding:2px 8px;font-size:11px;cursor:pointer;margin-left:6px;">\u270E Rename</button>':'')+' <a href="'+_agL('manualUrl')+'" target="_blank" title="Open the onboarding playbook (PDF)" style="display:inline-block;border:1px solid rgba(255,255,255,.25);color:#fff;border-radius:8px;padding:2px 8px;font-size:11px;text-decoration:none;margin-left:6px;">User manual</a>'+'</div>'
