# Cost-Compliance Sweep — 2026-07-24
_Principles: P1 $0-first · P2 budget every call · P3 independence/hot-swap. Sweep is static + $0; scanned 7 repos under `/sessions/adoring-clever-cori/mnt/Projects`._
...
- ✅ **OK** — bea_main.py:4784 `aa_market_note` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:4896 `listing_draft_from_photos` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:4964 `listing_draft_from_photo` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:5059 `aa_coach` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:8634 `trust_score_guidance` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:8884 `trust_score_upload_comment` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:9428 `_sonnet_verify_identity` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:11083 `_anon_ai_rewrite` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:12891 `vision_draft` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:13350 `ai_listing_rewrite` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:13432 `ai_seller_audit` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:14000 `ai_price_check` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:14311 `ai_yield_calc` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:14541 `ai_batch_card_listings` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:14801 `_classify_email` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:15229 `grade_card_condition` — ceiling ✓ spend-log ✓
...
- ℹ️ **INFO** — MarketSquare/bea_main.py:13300 model constant `PRICE_CHECK_MODEL` = claude-sonnet-4-6 — used by Tuppence-metered endpoints; keep justified
...
- **OpenAI** (13): `MarketSquare/add_openai_key.bat:19`, `MarketSquare/ai_provider.py:47`, `MarketSquare/ai_provider.py:113`, `MarketSquare/ai_provider.py:118`, `MarketSquare/bea_main.py:1317`, `MarketSquare/bea_main.py:1325`, `MarketSquare/bea_main.py:12229`, `MarketSquare/bea_main.py:12240`, `MarketSquare/main.py:1015`, `MarketSquare/main.py:1022`, `MarketSquare/main.py:9190`, `MarketSquare/subscription_monitor.py:123` …
...
- **Paystack (txn)** (3): `MarketSquare/bea_main.py:12102`, `MarketSquare/payments.py:32`, `MarketSquare/subscription_monitor.py:157`
