# Cost-Compliance Sweep — 2026-09-18
_Principles: P1 $0-first · P2 budget every call · P3 independence/hot-swap. Sweep is static + $0; scanned 7 repos under `/sessions/gallant-eager-goldberg/mnt/Projects`._

## Wrapper compliance — every AI call ceiling-checked + spend-logged (P2)

- ✅ **OK** — bea_main.py:4632 `_vision_orient_image` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:4847 `photos_order_suggest` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:7840 `aa_market_note` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:7953 `listing_draft_from_photos` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:8022 `listing_draft_from_photo` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:8118 `aa_coach` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:8442 `aa_coach_ask` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:12263 `trust_score_guidance` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:12614 `trust_score_upload_comment` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:13283 `_vision_verify_identity` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:16698 `_anon_ai_rewrite` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:19464 `vision_draft` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:19964 `ai_listing_rewrite` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:20053 `ai_seller_audit` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:20633 `ai_price_check` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:20947 `ai_yield_calc` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:21182 `ai_batch_card_listings` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:21569 `_classify_email` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:22606 `maint_brain` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:23294 `grade_card_condition` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:24721 `_squire_draft_brief` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:25438 `_ts_breaker_heartbeat` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:25510 `planner_heritage_compose` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:25439 `_hb_loop` — ceiling ✓ spend-log ✓
...
- ℹ️ **INFO** — MarketSquare/bea_main.py:19914 model constant `PRICE_CHECK_MODEL` = claude-sonnet-4-6 — used by Tuppence-metered endpoints; keep justified
...
- ℹ️ **INFO** — MarketSquare/DEFENCE_COVERAGE_MAP.html:153 Fable (claude-fable-5) in reference text — not a call site (DW-047)
...
- ℹ️ **INFO** — MarketSquare/DAILY_WATCH/OPEN_ITEMS.json:1379 Sonnet in a reference document describing the model field — not a call site (reference-doc exemption, 30 Aug 2026)
- ℹ️ **INFO** — MarketSquare/DAILY_WATCH/OPEN_ITEMS.json:1403 `claude-code` is the CLI tool / its GitHub repo, not a model family (DW-128)
- ℹ️ **INFO** — MarketSquare/DAILY_WATCH/OPEN_ITEMS.json:1403 `claude-code` is the CLI tool / its GitHub repo, not a model family (DW-128)
...
- ℹ️ **INFO** — MarketSquare/scripts/regression_ledger.py:3738 Fable (claude-fable-5) in reference text — not a call site (DW-047)
- ℹ️ **INFO** — MarketSquare/scripts/regression_ledger.py:16904 Fable (claude-fable-5) in reference text — not a call site (DW-047)
- ℹ️ **INFO** — MarketSquare/scripts/regression_ledger.py:21260 `claude-code` is the CLI tool / its GitHub repo, not a model family (DW-128)
- ℹ️ **INFO** — MarketSquare/scripts/regression_ledger.py:23135 `claude-code` is the CLI tool / its GitHub repo, not a model family (DW-128)
- ℹ️ **INFO** — MarketSquare/scripts/regression_ledger.py:23137 `claude-code` is the CLI tool / its GitHub repo, not a model family (DW-128)
- ℹ️ **INFO** — MarketSquare/scripts/regression_ledger.py:23151 `claude-code` is the CLI tool / its GitHub repo, not a model family (DW-128)
- ℹ️ **INFO** — MarketSquare/scripts/regression_ledger.py:23163 `claude-code` is the CLI tool / its GitHub repo, not a model family (DW-128)
...
- **Anthropic API** (18): `MarketSquare/ai_provider.py:118`, `MarketSquare/ai_provider.py:119`, `MarketSquare/main.py:1014`, `MarketSquare/main.py:1024`, `MarketSquare/subscription_monitor.py:122`, `MarketSquare/failover/ai_backends.py:13`, `MarketSquare/failover/ai_backends.py:142`, `MarketSquare/failover/ai_backends.py:144`, `MarketSquare/scripts/install_anthropic_key.py:58`, `MarketSquare/scripts/install_anthropic_key.py:59`, `MarketSquare/scripts/peer_pack_ai.py:62`, `MarketSquare/scripts/regression_ledger.py:1082` …
...
- **Paystack (txn)** (11): `MarketSquare/bea_main.py:14290`, `MarketSquare/bea_main.py:14300`, `MarketSquare/bea_main.py:14304`, `MarketSquare/bea_main.py:14307`, `MarketSquare/bea_main.py:14311`, `MarketSquare/bea_main.py:18211`, `MarketSquare/payments.py:32`, `MarketSquare/subscription_monitor.py:157`, `MarketSquare/scripts/audit_env_file.sh:8`, `MarketSquare/scripts/fix_paystack_env.py:71`, `MarketSquare/scripts/verify_paystack_key.sh:17`

**Totals:** 0 critical · 0 warnings · 31 ok · 57 info
