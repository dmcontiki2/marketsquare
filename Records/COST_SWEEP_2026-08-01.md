# Cost-Compliance Sweep — 2026-08-01
...
- ✅ **OK** — bea_main.py:3210 `_vision_orient_image` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:4836 `aa_market_note` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:4948 `listing_draft_from_photos` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:5016 `listing_draft_from_photo` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:5111 `aa_coach` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:8710 `trust_score_guidance` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:8960 `trust_score_upload_comment` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:9504 `_sonnet_verify_identity` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:11159 `_anon_ai_rewrite` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:12967 `vision_draft` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:13419 `ai_listing_rewrite` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:13501 `ai_seller_audit` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:14069 `ai_price_check` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:14380 `ai_yield_calc` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:14610 `ai_batch_card_listings` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:14870 `_classify_email` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:15328 `grade_card_condition` — ceiling ✓ spend-log ✓
- ✅ **OK** — advert_agent.py:785 `run_model` — metered via Tuppence hold/settle

## Model discipline — Haiku unless paid + metered (P1)

- 🟠 **WARN** — MarketSquare/ai_price_card.json:20 Sonnet outside the metered AdvertAgent registry — justify or downgrade to Haiku
...
- ℹ️ **INFO** — MarketSquare/bea_main.py:1273 Sonnet in the provider-model registry (TASK_MODEL/fallback) — single-source, Tuppence-metered; keep justified
- ℹ️ **INFO** — MarketSquare/bea_main.py:1274 Sonnet in the provider-model registry (TASK_MODEL/fallback) — single-source, Tuppence-metered; keep justified
- ℹ️ **INFO** — MarketSquare/bea_main.py:13369 model constant `PRICE_CHECK_MODEL` = claude-sonnet-4-6 — used by Tuppence-metered endpoints; keep justified
...
- **OpenAI** (21): `MarketSquare/add_openai_key.bat:19`, `MarketSquare/ai_provider.py:50`, `MarketSquare/ai_provider.py:118`, `MarketSquare/ai_provider.py:125`, `MarketSquare/bea_main.py:12305`, `MarketSquare/bea_main.py:12316`, `MarketSquare/bea_main.py:12986`, `MarketSquare/main.py:1015`, `MarketSquare/main.py:1022`, `MarketSquare/main.py:9190`, `MarketSquare/PEER_REVIEW.bat:7`, `MarketSquare/PEER_REVIEW.bat:8` …
...
- **Paystack (txn)** (3): `MarketSquare/bea_main.py:12178`, `MarketSquare/payments.py:32`, `MarketSquare/subscription_monitor.py:157`

**Totals:** 0 critical · 1 warnings · 24 ok · 27 info
