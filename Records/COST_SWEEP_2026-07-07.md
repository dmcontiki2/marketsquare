# Cost-Compliance Sweep — 2026-07-07
_Principles: P1 $0-first · P2 budget every call · P3 independence/hot-swap. Sweep is static + $0; scanned 7 repos under `/sessions/stoic-upbeat-ptolemy/mnt/Projects`._
...
- ✅ **OK** — bea_main.py:11095 `vision_draft` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:11542 `ai_listing_rewrite` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:11632 `ai_seller_audit` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:12149 `ai_price_check` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:12468 `ai_yield_calc` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:12706 `ai_batch_card_listings` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:12951 `_classify_email` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:13387 `grade_card_condition` — ceiling ✓ spend-log ✓
...
- ℹ️ **INFO** — MarketSquare/bea_main.py:11492 model constant `PRICE_CHECK_MODEL` = claude-sonnet-4-6 — used by Tuppence-metered endpoints; keep justified
...
- **OpenAI** (8): `MarketSquare/ai_provider.py:74`, `MarketSquare/ai_provider.py:79`, `MarketSquare/bea_main.py:1267`, `MarketSquare/bea_main.py:1274`, `MarketSquare/bea_main.py:10449`, `MarketSquare/main.py:1015`, `MarketSquare/main.py:1022`, `MarketSquare/main.py:9190`
