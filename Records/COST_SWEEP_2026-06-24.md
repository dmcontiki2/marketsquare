# Cost-Compliance Sweep — 2026-06-24
_Principles: P1 $0-first · P2 budget every call · P3 independence/hot-swap. Sweep is static + $0; scanned 7 repos under `/sessions/fervent-dreamy-curie/mnt/Projects`._
...
- 🟠 **WARN** — MarketSquare/claude_mem_digest.py:3 unknown model family `claude-mem` — classify
- 🟠 **WARN** — MarketSquare/claude_mem_digest.py:7 unknown model family `claude-mem` — classify
- 🟠 **WARN** — MarketSquare/claude_mem_digest.py:9 unknown model family `claude-mem` — classify
- 🟠 **WARN** — MarketSquare/claude_mem_digest.py:14 unknown model family `claude-mem` — classify
- 🟠 **WARN** — MarketSquare/claude_mem_digest.py:24 unknown model family `claude-mem` — classify
- 🟠 **WARN** — MarketSquare/claude_mem_digest.py:24 unknown model family `claude-mem.db` — classify
- 🟠 **WARN** — MarketSquare/claude_mem_digest.py:37 unknown model family `claude-mem` — classify
- 🟠 **WARN** — MarketSquare/claude_mem_digest.py:37 unknown model family `claude-mem.db` — classify
- 🟠 **WARN** — MarketSquare/claude_mem_digest.py:38 unknown model family `claude-mem` — classify
- 🟠 **WARN** — MarketSquare/claude_mem_digest.py:38 unknown model family `claude-mem.db` — classify
- 🟠 **WARN** — MarketSquare/claude_mem_digest.py:39 unknown model family `claude-mem` — classify
- 🟠 **WARN** — MarketSquare/claude_mem_digest.py:39 unknown model family `claude-mem.db` — classify
- 🟠 **WARN** — MarketSquare/claude_mem_digest.py:40 unknown model family `claude-mem` — classify
- 🟠 **WARN** — MarketSquare/claude_mem_digest.py:40 unknown model family `claude-mem.db` — classify
- 🟠 **WARN** — MarketSquare/claude_mem_digest.py:128 unknown model family `claude-mem` — classify
- 🟠 **WARN** — MarketSquare/claude_mem_digest.py:131 unknown model family `claude-mem.db` — classify
- 🟠 **WARN** — MarketSquare/claude_mem_digest.py:137 unknown model family `claude-mem.db` — classify
- 🟠 **WARN** — MarketSquare/claude_mem_digest.py:137 unknown model family `claude-mem` — classify
...
**Totals:** 0 critical · 18 warnings · 21 ok · 22 info
