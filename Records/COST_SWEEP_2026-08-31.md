# Cost-Compliance Sweep — 2026-08-31
_Principles: P1 $0-first · P2 budget every call · P3 independence/hot-swap. Sweep is static + $0; scanned 7 repos under `/sessions/peaceful-intelligent-keller/mnt/Projects`._

## Wrapper compliance — every AI call ceiling-checked + spend-logged (P2)

- ✅ **OK** — bea_main.py:4021 `_vision_orient_image` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:6493 `aa_market_note` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:6606 `listing_draft_from_photos` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:6675 `listing_draft_from_photo` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:6771 `aa_coach` — ceiling ✓ spend-log ✓
...
- ✅ **OK** — bea_main.py:19572 `grade_card_condition` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:20392 `_ts_breaker_heartbeat` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:20464 `planner_heritage_compose` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:20393 `_hb_loop` — ceiling ✓ spend-log ✓
...
- ℹ️ **INFO** — MarketSquare/scripts/regression_ledger.py:3539 Fable (claude-fable-5) in reference text — not a call site (DW-047)
