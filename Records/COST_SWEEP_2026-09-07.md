# Cost-Compliance Sweep — 2026-09-07
_Principles: P1 $0-first · P2 budget every call · P3 independence/hot-swap. Sweep is static + $0; scanned 7 repos under `/sessions/trusting-busy-meitner/mnt/Projects`._
...
- ✅ **OK** — bea_main.py:6790 `aa_market_note` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:6903 `listing_draft_from_photos` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:6972 `listing_draft_from_photo` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:7068 `aa_coach` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:7384 `aa_coach_ask` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:10838 `trust_score_guidance` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:11094 `trust_score_upload_comment` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:11751 `_sonnet_verify_identity` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:14763 `_anon_ai_rewrite` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:17474 `vision_draft` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:17974 `ai_listing_rewrite` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:18063 `ai_seller_audit` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:18643 `ai_price_check` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:18957 `ai_yield_calc` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:19192 `ai_batch_card_listings` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:19575 `_classify_email` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:20981 `grade_card_condition` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:22030 `_ts_breaker_heartbeat` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:22102 `planner_heritage_compose` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:22031 `_hb_loop` — ceiling ✓ spend-log ✓
...
- ℹ️ **INFO** — MarketSquare/bea_main.py:17924 model constant `PRICE_CHECK_MODEL` = claude-sonnet-4-6 — used by Tuppence-metered endpoints; keep justified
- ℹ️ **INFO** — MarketSquare/dashboard.server.html:1386 model name inside a UI display label — text on a diagram, not a call site (DW-009)
...
- ℹ️ **INFO** — MarketSquare/scripts/regression_ledger.py:3592 Fable (claude-fable-5) in reference text — not a call site (DW-047)
- ℹ️ **INFO** — MarketSquare/scripts/regression_ledger.py:16147 Fable (claude-fable-5) in reference text — not a call site (DW-047)
...
- **Paystack (txn)** (11): `MarketSquare/bea_main.py:12730`, `MarketSquare/bea_main.py:12740`, `MarketSquare/bea_main.py:12744`, `MarketSquare/bea_main.py:12747`, `MarketSquare/bea_main.py:12751`, `MarketSquare/bea_main.py:16234`, `MarketSquare/payments.py:32`, `MarketSquare/subscription_monitor.py:157`, `MarketSquare/scripts/audit_env_file.sh:8`, `MarketSquare/scripts/fix_paystack_env.py:71`, `MarketSquare/scripts/verify_paystack_key.sh:17`
