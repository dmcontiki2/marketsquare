# Cost-Compliance Sweep — 2026-08-21
_Principles: P1 $0-first · P2 budget every call · P3 independence/hot-swap. Sweep is static + $0; scanned 7 repos under `/sessions/affectionate-keen-tesla/mnt/Projects`._

## Wrapper compliance — every AI call ceiling-checked + spend-logged (P2)

- ✅ **OK** — bea_main.py:3939 `_vision_orient_image` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:5904 `aa_market_note` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:6017 `listing_draft_from_photos` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:6086 `listing_draft_from_photo` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:6182 `aa_coach` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:9835 `trust_score_guidance` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:10091 `trust_score_upload_comment` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:10748 `_sonnet_verify_identity` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:13063 `_anon_ai_rewrite` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:15272 `vision_draft` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:15767 `ai_listing_rewrite` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:15856 `ai_seller_audit` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:16429 `ai_price_check` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:16743 `ai_yield_calc` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:16978 `ai_batch_card_listings` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:17241 `_classify_email` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:18172 `grade_card_condition` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:18937 `_ts_breaker_heartbeat` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:19009 `planner_heritage_compose` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:18938 `_hb_loop` — ceiling ✓ spend-log ✓
...
- ℹ️ **INFO** — MarketSquare/bea_main.py:15717 model constant `PRICE_CHECK_MODEL` = claude-sonnet-4-6 — used by Tuppence-metered endpoints; keep justified
...
- ℹ️ **INFO** — MarketSquare/DEFENCE_COVERAGE_MAP.html:98 Fable (claude-fable-5) in reference text — not a call site (DW-047)
...
- ℹ️ **INFO** — MarketSquare/DAILY_WATCH/OPEN_ITEMS.json:425 Fable (claude-fable-5) in reference text — not a call site (DW-047)
...
- **Google APIs** (17): `MarketSquare/ai_provider.py:226`, `MarketSquare/bea_main.py:12476`, `MarketSquare/bea_main.py:12477`, `MarketSquare/bea_main.py:14373`, `MarketSquare/citylauncher_ops.html:717`, `CityLauncher/citylauncher_launch.html:1052`, `CityLauncher/CITYLAUNCHER_REDESIGN.html:50`, `CityLauncher/api/server.py:172`, `CityLauncher/dashboard/citylauncher.html:899`, `CityLauncher/scraper/sources/google_maps.py:14`, `CityLauncher/scraper/sources/google_maps.py:185`, `CityLauncher/scraper/sources/google_maps.py:218` …
- **OpenAI** (41): `MarketSquare/add_openai_key.bat:10`, `MarketSquare/add_openai_key.bat:11`, `MarketSquare/add_openai_key.bat:11`, `MarketSquare/add_openai_key.bat:13`, `MarketSquare/AI_BASELINE.json:442`, `MarketSquare/ai_provider.py:59`, `MarketSquare/ai_provider.py:156`, `MarketSquare/ai_provider.py:168`, `MarketSquare/ai_provider.py:292`, `MarketSquare/bea_main.py:14395`, `MarketSquare/bea_main.py:14528`, `MarketSquare/bea_main.py:14539` …
...
- **Paystack (txn)** (3): `MarketSquare/bea_main.py:14292`, `MarketSquare/payments.py:32`, `MarketSquare/subscription_monitor.py:157`

**Totals:** 0 critical · 9 warnings · 27 ok · 32 info
