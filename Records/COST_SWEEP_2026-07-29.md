...
- ✅ **OK** — bea_main.py:4843 `aa_market_note` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:4955 `listing_draft_from_photos` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:5023 `listing_draft_from_photo` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:5118 `aa_coach` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:8717 `trust_score_guidance` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:8967 `trust_score_upload_comment` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:9511 `_sonnet_verify_identity` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:11166 `_anon_ai_rewrite` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:12974 `vision_draft` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:13433 `ai_listing_rewrite` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:13515 `ai_seller_audit` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:14083 `ai_price_check` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:14394 `ai_yield_calc` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:14624 `ai_batch_card_listings` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:14884 `_classify_email` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:15312 `grade_card_condition` — ceiling ✓ spend-log ✓
...
- ℹ️ **INFO** — MarketSquare/bea_main.py:13383 model constant `PRICE_CHECK_MODEL` = claude-sonnet-4-6 — used by Tuppence-metered endpoints; keep justified
...
- **OpenAI** (13): `MarketSquare/add_openai_key.bat:19`, `MarketSquare/ai_provider.py:47`, `MarketSquare/ai_provider.py:113`, `MarketSquare/ai_provider.py:118`, `MarketSquare/bea_main.py:1317`, `MarketSquare/bea_main.py:1325`, `MarketSquare/bea_main.py:12312`, `MarketSquare/bea_main.py:12323`, `MarketSquare/main.py:1015`, `MarketSquare/main.py:1022`, `MarketSquare/main.py:9190`, `MarketSquare/subscription_monitor.py:123` …
...
- **Paystack (txn)** (3): `MarketSquare/bea_main.py:12185`, `MarketSquare/payments.py:32`, `MarketSquare/subscription_monitor.py:157`
