# Cost-Compliance Sweep — 2026-07-29
_Principles: P1 $0-first · P2 budget every call · P3 independence/hot-swap. Sweep is static + $0; scanned 7 repos under `/sessions/sharp-practical-lamport/mnt/Projects`._

## Wrapper compliance — every AI call ceiling-checked + spend-logged (P2)

- ✅ **OK** — bea_main.py:3217 `_vision_orient_image` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:4839 `aa_market_note` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:4951 `listing_draft_from_photos` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:5019 `listing_draft_from_photo` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:5114 `aa_coach` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:8713 `trust_score_guidance` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:8963 `trust_score_upload_comment` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:9507 `_sonnet_verify_identity` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:11162 `_anon_ai_rewrite` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:12970 `vision_draft` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:13429 `ai_listing_rewrite` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:13511 `ai_seller_audit` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:14079 `ai_price_check` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:14390 `ai_yield_calc` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:14620 `ai_batch_card_listings` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:14880 `_classify_email` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:15308 `grade_card_condition` — ceiling ✓ spend-log ✓
...
- ℹ️ **INFO** — MarketSquare/bea_main.py:1268 Sonnet in the provider-model registry (TASK_MODEL/fallback) — single-source, Tuppence-metered; keep justified
- ℹ️ **INFO** — MarketSquare/bea_main.py:1269 Sonnet in the provider-model registry (TASK_MODEL/fallback) — single-source, Tuppence-metered; keep justified
- ℹ️ **INFO** — MarketSquare/bea_main.py:13379 model constant `PRICE_CHECK_MODEL` = claude-sonnet-4-6 — used by Tuppence-metered endpoints; keep justified
...
- ℹ️ **INFO** — MarketSquare/_to_delete_base40_proof/bea_main.py:1268 Sonnet in the provider-model registry (TASK_MODEL/fallback) — single-source, Tuppence-metered; keep justified
- ℹ️ **INFO** — MarketSquare/_to_delete_base40_proof/bea_main.py:1269 Sonnet in the provider-model registry (TASK_MODEL/fallback) — single-source, Tuppence-metered; keep justified
- ℹ️ **INFO** — MarketSquare/_to_delete_base40_proof/bea_main.py:13348 model constant `PRICE_CHECK_MODEL` = claude-sonnet-4-6 — used by Tuppence-metered endpoints; keep justified
...
- ℹ️ **INFO** — Workbook last modified 2026-07-22; latest CHANGELOG cost-impact entry: 22 Jul 2026 — reconcile if the code moved later
...
## Paid call-site inventory (121 hits)

- **Anthropic API** (16): `MarketSquare/ai_provider.py:74`, `MarketSquare/ai_provider.py:75`, `MarketSquare/bea_main.py:1316`, `MarketSquare/bea_main.py:1328`, `MarketSquare/main.py:1014`, `MarketSquare/main.py:1024`, `MarketSquare/subscription_monitor.py:122`, `MarketSquare/failover/ai_backends.py:13`, `MarketSquare/failover/ai_backends.py:142`, `MarketSquare/failover/ai_backends.py:144`, `MarketSquare/_to_delete_base40_proof/bea_main.py:1316`, `MarketSquare/_to_delete_base40_proof/bea_main.py:1328` …
...
- **OpenAI** (17): `MarketSquare/add_openai_key.bat:19`, `MarketSquare/ai_provider.py:47`, `MarketSquare/ai_provider.py:113`, `MarketSquare/ai_provider.py:118`, `MarketSquare/bea_main.py:1317`, `MarketSquare/bea_main.py:1325`, `MarketSquare/bea_main.py:12308`, `MarketSquare/bea_main.py:12319`, `MarketSquare/main.py:1015`, `MarketSquare/main.py:1022`, `MarketSquare/main.py:9190`, `MarketSquare/subscription_monitor.py:123` …
...
- **Paystack (txn)** (4): `MarketSquare/bea_main.py:12181`, `MarketSquare/payments.py:32`, `MarketSquare/subscription_monitor.py:157`, `MarketSquare/_to_delete_base40_proof/bea_main.py:12150`

**Totals:** 0 critical · 0 warnings · 24 ok · 30 info
