# Cost-Compliance Sweep — 2026-09-13
_Principles: P1 $0-first · P2 budget every call · P3 independence/hot-swap. Sweep is static + $0; scanned 7 repos under `/sessions/wonderful-ecstatic-planck/mnt/Projects`._

## Wrapper compliance — every AI call ceiling-checked + spend-logged (P2)

- ✅ **OK** — bea_main.py:4279 `_vision_orient_image` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:6884 `aa_market_note` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:6997 `listing_draft_from_photos` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:7066 `listing_draft_from_photo` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:7162 `aa_coach` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:7478 `aa_coach_ask` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:10977 `trust_score_guidance` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:11240 `trust_score_upload_comment` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:11897 `_sonnet_verify_identity` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:14992 `_anon_ai_rewrite` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:17703 `vision_draft` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:18203 `ai_listing_rewrite` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:18292 `ai_seller_audit` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:18872 `ai_price_check` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:19186 `ai_yield_calc` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:19421 `ai_batch_card_listings` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:19804 `_classify_email` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:21210 `grade_card_condition` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:22260 `_ts_breaker_heartbeat` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:22332 `planner_heritage_compose` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:22261 `_hb_loop` — ceiling ✓ spend-log ✓
...
- ℹ️ **INFO** — MarketSquare/bea_main.py:1726 Sonnet in the provider-model registry (TASK_MODEL/fallback) — single-source, Tuppence-metered; keep justified
- ℹ️ **INFO** — MarketSquare/bea_main.py:18153 model constant `PRICE_CHECK_MODEL` = claude-sonnet-4-6 — used by Tuppence-metered endpoints; keep justified
- 🟠 **WARN** — MarketSquare/boards_host.bat:4 unknown model family `claude-code` — classify
- ℹ️ **INFO** — MarketSquare/dashboard.server.html:1425 model name inside a UI display label — text on a diagram, not a call site (DW-009)
...
- ℹ️ **INFO** — MarketSquare/ledger_runs/shard-02-of-03.json:1150 Fable (claude-fable-5) in reference text — not a call site (DW-047)
- 🟠 **WARN** — MarketSquare/ledger_runs/shard-02-of-03.json:1442 unknown model family `claude-code` — classify
...
- ℹ️ **INFO** — MarketSquare/scripts/regression_ledger.py:16371 Fable (claude-fable-5) in reference text — not a call site (DW-047)
- 🟠 **WARN** — MarketSquare/scripts/regression_ledger.py:20669 unknown model family `claude-code` — classify
...
- **Paystack (txn)** (11): `MarketSquare/bea_main.py:12893`, `MarketSquare/bea_main.py:12903`, `MarketSquare/bea_main.py:12907`, `MarketSquare/bea_main.py:12910`, `MarketSquare/bea_main.py:12914`, `MarketSquare/bea_main.py:16463`, `MarketSquare/payments.py:32`, `MarketSquare/subscription_monitor.py:157`, `MarketSquare/scripts/audit_env_file.sh:8`, `MarketSquare/scripts/fix_paystack_env.py:71`, `MarketSquare/scripts/verify_paystack_key.sh:17`
