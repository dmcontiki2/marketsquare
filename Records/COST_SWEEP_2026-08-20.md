# Cost-Compliance Sweep — 2026-08-20
_Principles: P1 $0-first · P2 budget every call · P3 independence/hot-swap. Sweep is static + $0; scanned 7 repos under `/sessions/wonderful-tender-rubin/mnt/Projects`._
...
- ✅ **OK** — bea_main.py:13064 `_anon_ai_rewrite` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:15273 `vision_draft` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:15768 `ai_listing_rewrite` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:15857 `ai_seller_audit` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:16430 `ai_price_check` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:16744 `ai_yield_calc` — ceiling ✓ spend-log ✓
...
- 🔴 **CRITICAL** — MarketSquare/AI_BASELINE.json:291 uses OPUS (claude-opus-4-6) — cost model rejected Opus
