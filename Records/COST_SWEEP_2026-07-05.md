# Cost-Compliance Sweep — 2026-07-05
_Principles: P1 $0-first · P2 budget every call · P3 independence/hot-swap. Sweep is static + $0; scanned 7 repos under `/sessions/jolly-sharp-clarke/mnt/Projects`._

## Wrapper compliance — every AI call ceiling-checked + spend-logged (P2)

- ✅ **OK** — bea_main.py:2685 `_vision_orient_image` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:4058 `listing_draft_from_photos` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:4130 `listing_draft_from_photo` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:4229 `aa_coach` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:7467 `trust_score_guidance` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:7724 `trust_score_upload_comment` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:10120 `vision_draft` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:10567 `ai_listing_rewrite` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:10657 `ai_seller_audit` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:11174 `ai_price_check` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:11493 `ai_yield_calc` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:11731 `ai_batch_card_listings` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:11976 `_classify_email` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:12412 `grade_card_condition` — ceiling ✓ spend-log ✓
- ✅ **OK** — advert_agent.py:764 `run_model` — metered via Tuppence hold/settle
...
- ℹ️ **INFO** — MarketSquare/bea_main.py:983 Sonnet in the provider-model registry (TASK_MODEL/fallback) — single-source, Tuppence-metered; keep justified
- ℹ️ **INFO** — MarketSquare/bea_main.py:984 Sonnet in the provider-model registry (TASK_MODEL/fallback) — single-source, Tuppence-metered; keep justified
- ℹ️ **INFO** — MarketSquare/bea_main.py:10517 model constant `PRICE_CHECK_MODEL` = claude-sonnet-4-6 — used by Tuppence-metered endpoints; keep justified
...
- ℹ️ **INFO** — AdvertAgent/service/advert_agent.py:254 Sonnet — allowed: paid Level-2, Tuppence-metered
- ℹ️ **INFO** — AdvertAgent/service/advert_agent.py:304 Sonnet — allowed: paid Level-2, Tuppence-metered
- ℹ️ **INFO** — AdvertAgent/service/advert_agent.py:349 Sonnet — allowed: paid Level-2, Tuppence-metered
- ℹ️ **INFO** — AdvertAgent/service/advert_agent.py:383 Sonnet — allowed: paid Level-2, Tuppence-metered
- ℹ️ **INFO** — AdvertAgent/service/advert_agent.py:488 Sonnet — allowed: paid Level-2, Tuppence-metered
- ℹ️ **INFO** — AdvertAgent/service/advert_agent.py:522 Sonnet — allowed: paid Level-2, Tuppence-metered
- ℹ️ **INFO** — AdvertAgent/service/advert_agent.py:571 Sonnet — allowed: paid Level-2, Tuppence-metered
- ℹ️ **INFO** — AdvertAgent/service/advert_agent.py:633 Sonnet — allowed: paid Level-2, Tuppence-metered
...
- **Anthropic API** (13): `MarketSquare/ai_provider.py:38`, `MarketSquare/ai_provider.py:39`, `MarketSquare/bea_main.py:1031`, `MarketSquare/bea_main.py:1041`, `MarketSquare/main.py:1014`, `MarketSquare/main.py:1024`, `MarketSquare/failover/ai_backends.py:13`, `MarketSquare/failover/ai_backends.py:142`, `MarketSquare/failover/ai_backends.py:144`, `AdvertAgent/run_video_reports.py:37`, `AdvertAgent/run_video_reports.py:125`, `AdvertAgent/service/advert_agent.py:29` …
- **Anthropic SDK** (6): `MarketSquare/bea_main.py:8301`, `MarketSquare/data_audit.py:154`, `MarketSquare/main.py:8028`, `CityLauncher/emailer/emailer.py:99`, `CityLauncher/orchestration/haiko_agent.py:228`, `CityLauncher/orchestration/strategist_agent.py:301`
...
- **OpenAI** (8): `MarketSquare/ai_provider.py:74`, `MarketSquare/ai_provider.py:79`, `MarketSquare/bea_main.py:1032`, `MarketSquare/bea_main.py:1039`, `MarketSquare/bea_main.py:9474`, `MarketSquare/main.py:1015`, `MarketSquare/main.py:1022`, `MarketSquare/main.py:9190`
...
**Totals:** 0 critical · 0 warnings · 21 ok · 27 info
