# Cost-Compliance Sweep — 2026-07-08
_Principles: P1 $0-first · P2 budget every call · P3 independence/hot-swap. Sweep is static + $0; scanned 7 repos under `/sessions/tender-wonderful-hopper/mnt/Projects`._
...
- ✅ **OK** — bea_main.py:11530 `vision_draft` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:11977 `ai_listing_rewrite` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:12067 `ai_seller_audit` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:12584 `ai_price_check` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:12903 `ai_yield_calc` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:13141 `ai_batch_card_listings` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:13386 `_classify_email` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:13822 `grade_card_condition` — ceiling ✓ spend-log ✓
...
- ℹ️ **INFO** — MarketSquare/bea_main.py:11927 model constant `PRICE_CHECK_MODEL` = claude-sonnet-4-6 — used by Tuppence-metered endpoints; keep justified
...
- **OpenAI** (8): `MarketSquare/ai_provider.py:74`, `MarketSquare/ai_provider.py:79`, `MarketSquare/bea_main.py:1267`, `MarketSquare/bea_main.py:1274`, `MarketSquare/bea_main.py:10884`, `MarketSquare/main.py:1015`, `MarketSquare/main.py:1022`, `MarketSquare/main.py:9190`
