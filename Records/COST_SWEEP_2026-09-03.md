# Cost-Compliance Sweep — 2026-09-03
_Principles: P1 $0-first · P2 budget every call · P3 independence/hot-swap. Sweep is static + $0; scanned 7 repos under `/sessions/ecstatic-charming-planck/mnt/Projects`._

## Wrapper compliance — every AI call ceiling-checked + spend-logged (P2)

- ✅ **OK** — bea_main.py:4190 `_vision_orient_image` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:6662 `aa_market_note` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:6775 `listing_draft_from_photos` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:6844 `listing_draft_from_photo` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:6940 `aa_coach` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:10614 `trust_score_guidance` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:10870 `trust_score_upload_comment` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:11527 `_sonnet_verify_identity` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:14402 `_anon_ai_rewrite` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:16990 `vision_draft` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:17490 `ai_listing_rewrite` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:17579 `ai_seller_audit` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:18159 `ai_price_check` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:18473 `ai_yield_calc` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:18708 `ai_batch_card_listings` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:19063 `_classify_email` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:20184 `grade_card_condition` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:21004 `_ts_breaker_heartbeat` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:21076 `planner_heritage_compose` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:21005 `_hb_loop` — ceiling ✓ spend-log ✓
...
- ℹ️ **INFO** — MarketSquare/bea_main.py:17440 model constant `PRICE_CHECK_MODEL` = claude-sonnet-4-6 — used by Tuppence-metered endpoints; keep justified
- ℹ️ **INFO** — MarketSquare/dashboard.server.html:1303 model name inside a UI display label — text on a diagram, not a call site (DW-009)
...
- ℹ️ **INFO** — MarketSquare/scripts/maintenance_agent.py:362 Fable (claude-fable-5) in reference text — not a call site (DW-047)
- ℹ️ **INFO** — MarketSquare/scripts/regression_ledger.py:3553 Fable (claude-fable-5) in reference text — not a call site (DW-047)
- 🟠 **WARN** — MarketSquare/scripts/regression_ledger.py:14119 unknown model family `claude-relay` — classify
- 🟠 **WARN** — MarketSquare/scripts/regression_ledger.py:14119 unknown model family `claude-relay` — classify
- 🟠 **WARN** — MarketSquare/scripts/request_deploy.py:42 unknown model family `claude-relay` — classify
- 🟠 **WARN** — MarketSquare/scripts/request_deploy.py:46 unknown model family `claude-relay` — classify
- 🟠 **WARN** — MarketSquare/scripts/request_deploy.py:46 unknown model family `claude-relay` — classify
...
- **Anthropic SDK** (5): `MarketSquare/data_audit.py:154`, `MarketSquare/main.py:8028`, `CityLauncher/emailer/emailer.py:126`, `CityLauncher/orchestration/haiko_agent.py:228`, `CityLauncher/orchestration/strategist_agent.py:301`
- **Google APIs** (17): `MarketSquare/ai_provider.py:226`, `MarketSquare/bea_main.py:13711`, `MarketSquare/bea_main.py:13712`, `MarketSquare/bea_main.py:16065`, `MarketSquare/citylauncher_ops.html:727`, `CityLauncher/citylauncher_launch.html:1089`, `CityLauncher/CITYLAUNCHER_REDESIGN.html:50`, `CityLauncher/api/server.py:429`, `CityLauncher/dashboard/citylauncher.html:928`, `CityLauncher/scraper/sources/google_maps.py:14`, `CityLauncher/scraper/sources/google_maps.py:217`, `CityLauncher/scraper/sources/google_maps.py:250` …
- **OpenAI** (41): `MarketSquare/add_openai_key.bat:10`, `MarketSquare/add_openai_key.bat:11`, `MarketSquare/add_openai_key.bat:11`, `MarketSquare/add_openai_key.bat:13`, `MarketSquare/AI_BASELINE.json:442`, `MarketSquare/ai_provider.py:59`, `MarketSquare/ai_provider.py:156`, `MarketSquare/ai_provider.py:168`, `MarketSquare/ai_provider.py:292`, `MarketSquare/bea_main.py:16087`, `MarketSquare/bea_main.py:16220`, `MarketSquare/bea_main.py:16231` …
...
- **Paystack (txn)** (11): `MarketSquare/bea_main.py:12506`, `MarketSquare/bea_main.py:12516`, `MarketSquare/bea_main.py:12520`, `MarketSquare/bea_main.py:12523`, `MarketSquare/bea_main.py:12527`, `MarketSquare/bea_main.py:15873`, `MarketSquare/payments.py:32`, `MarketSquare/subscription_monitor.py:157`, `MarketSquare/scripts/audit_env_file.sh:8`, `MarketSquare/scripts/fix_paystack_env.py:71`, `MarketSquare/scripts/verify_paystack_key.sh:17`

**Totals:** 0 critical · 5 warnings · 27 ok · 40 info
