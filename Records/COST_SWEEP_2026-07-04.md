# Cost-Compliance Sweep — 2026-07-04
_Principles: P1 $0-first · P2 budget every call · P3 independence/hot-swap. Sweep is static + $0; scanned 7 repos under `/sessions/relaxed-optimistic-brahmagupta/mnt/Projects`._
...
- ✅ **OK** — bea_main.py:7217 `trust_score_guidance` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:7474 `trust_score_upload_comment` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:9858 `vision_draft` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:10292 `ai_listing_rewrite` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:10382 `ai_seller_audit` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:10899 `ai_price_check` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:11218 `ai_yield_calc` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:11456 `ai_batch_card_listings` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:11701 `_classify_email` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:12137 `grade_card_condition` — ceiling ✓ spend-log ✓
...
- ℹ️ **INFO** — MarketSquare/bea_main.py:10242 model constant `PRICE_CHECK_MODEL` = claude-sonnet-4-6 — used by Tuppence-metered endpoints; keep justified
...
- **Anthropic SDK** (6): `MarketSquare/bea_main.py:8051`, `MarketSquare/data_audit.py:154`, `MarketSquare/main.py:8028`, `CityLauncher/emailer/emailer.py:99`, `CityLauncher/orchestration/haiko_agent.py:228`, `CityLauncher/orchestration/strategist_agent.py:301`
...
- **OpenAI** (8): `MarketSquare/ai_provider.py:74`, `MarketSquare/ai_provider.py:79`, `MarketSquare/bea_main.py:1015`, `MarketSquare/bea_main.py:1022`, `MarketSquare/bea_main.py:9224`, `MarketSquare/main.py:1015`, `MarketSquare/main.py:1022`, `MarketSquare/main.py:9190`
