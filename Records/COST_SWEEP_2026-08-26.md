...
- ✅ **OK** — bea_main.py:20049 `_ts_breaker_heartbeat` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:20121 `planner_heritage_compose` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:20050 `_hb_loop` — ceiling ✓ spend-log ✓
...
- ℹ️ **INFO** — MarketSquare/dashboard.server.html:1219 model name inside a UI display label — text on a diagram, not a call site (DW-009)
