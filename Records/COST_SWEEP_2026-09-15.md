# Cost-Compliance Sweep — 2026-09-15
_Principles: P1 $0-first · P2 budget every call · P3 independence/hot-swap. Sweep is static + $0; scanned 7 repos under `/sessions/laughing-lucid-brahmagupta/mnt/Projects`._

## Wrapper compliance — every AI call ceiling-checked + spend-logged (P2)

- ✅ **OK** — bea_main.py:4335 `_vision_orient_image` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:7163 `aa_market_note` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:7276 `listing_draft_from_photos` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:7345 `listing_draft_from_photo` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:7441 `aa_coach` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:7765 `aa_coach_ask` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:11453 `trust_score_guidance` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:11804 `trust_score_upload_comment` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:12473 `_sonnet_verify_identity` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:15812 `_anon_ai_rewrite` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:18523 `vision_draft` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:19023 `ai_listing_rewrite` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:19112 `ai_seller_audit` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:19692 `ai_price_check` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:20006 `ai_yield_calc` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:20241 `ai_batch_card_listings` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:20628 `_classify_email` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:22036 `grade_card_condition` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:23470 `_ts_breaker_heartbeat` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:23542 `planner_heritage_compose` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:23471 `_hb_loop` — ceiling ✓ spend-log ✓
...
- ℹ️ **INFO** — MarketSquare/bea_main.py:1782 Sonnet in the provider-model registry (TASK_MODEL/fallback) — single-source, Tuppence-metered; keep justified
- ℹ️ **INFO** — MarketSquare/bea_main.py:18973 model constant `PRICE_CHECK_MODEL` = claude-sonnet-4-6 — used by Tuppence-metered endpoints; keep justified
...
- ℹ️ **INFO** — MarketSquare/DEFENCE_COVERAGE_MAP.html:146 Fable (claude-fable-5) in reference text — not a call site (DW-047)
...
- ℹ️ **INFO** — MarketSquare/ledger_runs/shard-03-of-03.json:284 Fable (claude-fable-5) in reference text — not a call site (DW-047)
- ℹ️ **INFO** — MarketSquare/ledger_runs/shard-03-of-03.json:1169 Fable (claude-fable-5) in reference text — not a call site (DW-047)
- 🟠 **WARN** — MarketSquare/ledger_runs/shard-03-of-03.json:1461 unknown model family `claude-code` — classify
...
- 🟠 **WARN** — MarketSquare/scripts/regression_ledger.py:21032 unknown model family `claude-code` — classify
...
- **Paystack (txn)** (11): `MarketSquare/bea_main.py:13480`, `MarketSquare/bea_main.py:13490`, `MarketSquare/bea_main.py:13494`, `MarketSquare/bea_main.py:13497`, `MarketSquare/bea_main.py:13501`, `MarketSquare/bea_main.py:17283`, `MarketSquare/payments.py:32`, `MarketSquare/subscription_monitor.py:157`, `MarketSquare/scripts/audit_env_file.sh:8`, `MarketSquare/scripts/fix_paystack_env.py:71`, `MarketSquare/scripts/verify_paystack_key.sh:17`

**Totals:** 0 critical · 7 warnings · 28 ok · 48 info
