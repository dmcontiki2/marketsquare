# Cost-Compliance Sweep — 2026-09-10
_Principles: P1 $0-first · P2 budget every call · P3 independence/hot-swap. Sweep is static + $0; scanned 7 repos under `/sessions/practical-festive-franklin/mnt/Projects`._
...
- ℹ️ **INFO** — MarketSquare/ledger_runs/shard-02-of-03.json:1221 Fable (claude-fable-5) in reference text — not a call site (DW-047)
- 🟠 **WARN** — MarketSquare/ledger_runs/shard-02-of-03.json:1513 unknown model family `claude-code` — classify
...
**Totals:** 0 critical · 5 warnings · 28 ok · 48 info
