# Cost-Compliance Sweep — 2026-06-15
_Principles: P1 $0-first · P2 budget every call · P3 independence/hot-swap. Sweep is static + $0; scanned 7 repos under the Projects workspace._
...
- **Anthropic API** (35): `MarketSquare/bea_main.py:2337`, `MarketSquare/bea_main.py:2339`, `MarketSquare/bea_main.py:3576`, `MarketSquare/bea_main.py:3579`, `MarketSquare/bea_main.py:3720`, `MarketSquare/bea_main.py:3722`, `MarketSquare/bea_main.py:3795`, `MarketSquare/bea_main.py:3797`, `MarketSquare/bea_main.py:4099`, `MarketSquare/bea_main.py:4102`, `MarketSquare/bea_main.py:7135`, `MarketSquare/bea_main.py:7138` …
...
_Operator note (automated run, 2026-06-15): the sweep script in the current working tree still references the pre-rename repo name "TrustSquare"; the live folder is "MarketSquare". Tonight's sweep ran the unmodified script against the real MarketSquare tree via a read-only compatibility shim, and path labels were normalized to "MarketSquare/" for continuity. Recommend reconciling scripts/cost_compliance_sweep.py (REPOS list + output path) to the current folder name._
