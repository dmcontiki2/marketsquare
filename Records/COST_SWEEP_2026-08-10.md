# Cost-Compliance Sweep — 2026-08-10
_Principles: P1 $0-first · P2 budget every call · P3 independence/hot-swap. Sweep is static + $0; scanned 7 repos under `/sessions/wizardly-determined-turing/mnt/Projects`._

## Wrapper compliance — every AI call ceiling-checked + spend-logged (P2)

- ✅ **OK** — bea_main.py:3629 `_vision_orient_image` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:5582 `aa_market_note` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:5694 `listing_draft_from_photos` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:5762 `listing_draft_from_photo` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:5857 `aa_coach` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:9483 `trust_score_guidance` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:9738 `trust_score_upload_comment` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:10392 `_sonnet_verify_identity` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:12129 `_anon_ai_rewrite` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:14189 `vision_draft` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:14641 `ai_listing_rewrite` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:14729 `ai_seller_audit` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:15301 `ai_price_check` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:15614 `ai_yield_calc` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:15846 `ai_batch_card_listings` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:16108 `_classify_email` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:16985 `grade_card_condition` — ceiling ✓ spend-log ✓
- 🟠 **WARN** — bea_main.py:17739 `_ts_breaker_heartbeat` — spend-log ✓ but NO _check_cost_ceiling
- 🟠 **WARN** — bea_main.py:17740 `_hb_loop` — spend-log ✓ but NO _check_cost_ceiling
...
- ℹ️ **INFO** — MarketSquare/bea_main.py:1499 Sonnet in the provider-model registry (TASK_MODEL/fallback) — single-source, Tuppence-metered; keep justified
- ℹ️ **INFO** — MarketSquare/bea_main.py:1500 Sonnet in the provider-model registry (TASK_MODEL/fallback) — single-source, Tuppence-metered; keep justified
- ℹ️ **INFO** — MarketSquare/bea_main.py:14591 model constant `PRICE_CHECK_MODEL` = claude-sonnet-4-6 — used by Tuppence-metered endpoints; keep justified
- 🟠 **WARN** — MarketSquare/dashboard.server.html:1110 Sonnet outside the metered AdvertAgent registry — justify or downgrade to Haiku
...
## Paid call-site inventory (133 hits)

- **Anthropic API** (14): `MarketSquare/ai_provider.py:95`, `MarketSquare/ai_provider.py:96`, `MarketSquare/main.py:1014`, `MarketSquare/main.py:1024`, `MarketSquare/subscription_monitor.py:122`, `MarketSquare/failover/ai_backends.py:13`, `MarketSquare/failover/ai_backends.py:142`, `MarketSquare/failover/ai_backends.py:144`, `MarketSquare/scripts/peer_pack_ai.py:62`, `MarketSquare/scripts/regression_ledger.py:720`, `AdvertAgent/run_video_reports.py:37`, `AdvertAgent/run_video_reports.py:125` …
...
- **Google APIs** (14): `MarketSquare/bea_main.py:13336`, `MarketSquare/citylauncher_ops.html:717`, `CityLauncher/citylauncher_launch.html:1052`, `CityLauncher/CITYLAUNCHER_REDESIGN.html:50`, `CityLauncher/api/server.py:172`, `CityLauncher/dashboard/citylauncher.html:899`, `CityLauncher/scraper/sources/google_maps.py:14`, `CityLauncher/scraper/sources/google_maps.py:185`, `CityLauncher/scraper/sources/google_maps.py:218`, `CityLauncher/scraper/sources/google_maps.py:495`, `CityLauncher/scraper/sources/google_maps.py:501`, `CityLauncher/scraper/sources/property24.py:320` …
- **OpenAI** (31): `MarketSquare/add_openai_key.bat:10`, `MarketSquare/add_openai_key.bat:11`, `MarketSquare/add_openai_key.bat:11`, `MarketSquare/add_openai_key.bat:13`, `MarketSquare/ai_provider.py:50`, `MarketSquare/ai_provider.py:138`, `MarketSquare/ai_provider.py:150`, `MarketSquare/ai_provider.py:204`, `MarketSquare/bea_main.py:13358`, `MarketSquare/bea_main.py:13490`, `MarketSquare/bea_main.py:13501`, `MarketSquare/bea_main.py:14208` …
...
- **Paystack (txn)** (3): `MarketSquare/bea_main.py:13255`, `MarketSquare/payments.py:32`, `MarketSquare/subscription_monitor.py:157`

**Totals:** 0 critical · 3 warnings · 24 ok · 28 info
