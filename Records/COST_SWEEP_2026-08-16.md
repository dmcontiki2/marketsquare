# Cost-Compliance Sweep — 2026-08-16
_Principles: P1 $0-first · P2 budget every call · P3 independence/hot-swap. Sweep is static + $0; scanned 7 repos under `/sessions/friendly-elegant-darwin/mnt/Projects`._

## Wrapper compliance — every AI call ceiling-checked + spend-logged (P2)

- ✅ **OK** — bea_main.py:3850 `_vision_orient_image` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:5805 `aa_market_note` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:5918 `listing_draft_from_photos` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:5987 `listing_draft_from_photo` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:6083 `aa_coach` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:9711 `trust_score_guidance` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:9967 `trust_score_upload_comment` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:10624 `_sonnet_verify_identity` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:12524 `_anon_ai_rewrite` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:14667 `vision_draft` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:15120 `ai_listing_rewrite` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:15209 `ai_seller_audit` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:15782 `ai_price_check` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:16096 `ai_yield_calc` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:16331 `ai_batch_card_listings` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:16594 `_classify_email` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:17525 `grade_card_condition` — ceiling ✓ spend-log ✓
- 🟠 **WARN** — bea_main.py:18280 `_ts_breaker_heartbeat` — spend-log ✓ but NO _check_cost_ceiling
- 🟠 **WARN** — bea_main.py:18281 `_hb_loop` — spend-log ✓ but NO _check_cost_ceiling
...
- ℹ️ **INFO** — MarketSquare/bea_main.py:1557 Sonnet in the provider-model registry (TASK_MODEL/fallback) — single-source, Tuppence-metered; keep justified
- ℹ️ **INFO** — MarketSquare/bea_main.py:15070 model constant `PRICE_CHECK_MODEL` = claude-sonnet-4-6 — used by Tuppence-metered endpoints; keep justified
...
- 🔴 **CRITICAL** — MarketSquare/DEFENCE_COVERAGE_MAP.html:31 uses OPUS (claude-opus-4-6) — cost model rejected Opus
- 🔴 **CRITICAL** — MarketSquare/DEFENCE_COVERAGE_MAP.html:90 uses OPUS (claude-opus-4-6) — cost model rejected Opus
...
- 🔴 **CRITICAL** — MarketSquare/DAILY_WATCH/OPEN_ITEMS.json:353 uses OPUS (claude-opus-4-6.) — cost model rejected Opus
...
- 🟠 **WARN** — MarketSquare/scripts/regression_ledger.py:3187 unknown model family `claude-fable-5` — classify
...
- **Google APIs** (14): `MarketSquare/bea_main.py:13768`, `MarketSquare/citylauncher_ops.html:717`, `CityLauncher/citylauncher_launch.html:1052`, `CityLauncher/CITYLAUNCHER_REDESIGN.html:50`, `CityLauncher/api/server.py:172`, `CityLauncher/dashboard/citylauncher.html:899`, `CityLauncher/scraper/sources/google_maps.py:14`, `CityLauncher/scraper/sources/google_maps.py:185`, `CityLauncher/scraper/sources/google_maps.py:218`, `CityLauncher/scraper/sources/google_maps.py:495`, `CityLauncher/scraper/sources/google_maps.py:501`, `CityLauncher/scraper/sources/property24.py:320` …
- **OpenAI** (40): `MarketSquare/add_openai_key.bat:10`, `MarketSquare/add_openai_key.bat:11`, `MarketSquare/add_openai_key.bat:11`, `MarketSquare/add_openai_key.bat:13`, `MarketSquare/AI_BASELINE.json:428`, `MarketSquare/ai_provider.py:59`, `MarketSquare/ai_provider.py:149`, `MarketSquare/ai_provider.py:161`, `MarketSquare/ai_provider.py:261`, `MarketSquare/bea_main.py:13790`, `MarketSquare/bea_main.py:13923`, `MarketSquare/bea_main.py:13934` …
...
- **Paystack (txn)** (3): `MarketSquare/bea_main.py:13687`, `MarketSquare/payments.py:32`, `MarketSquare/subscription_monitor.py:157`

**Totals:** 5 critical · 13 warnings · 24 ok · 28 info
