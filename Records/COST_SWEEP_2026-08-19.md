# Cost-Compliance Sweep — 2026-08-19
_Principles: P1 $0-first · P2 budget every call · P3 independence/hot-swap. Sweep is static + $0; scanned 7 repos under `/sessions/magical-sleepy-bardeen/mnt/Projects`._

## Wrapper compliance — every AI call ceiling-checked + spend-logged (P2)

- ✅ **OK** — bea_main.py:3895 `_vision_orient_image` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:5852 `aa_market_note` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:5965 `listing_draft_from_photos` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:6034 `listing_draft_from_photo` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:6130 `aa_coach` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:9783 `trust_score_guidance` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:10039 `trust_score_upload_comment` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:10696 `_sonnet_verify_identity` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:13006 `_anon_ai_rewrite` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:15174 `vision_draft` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:15669 `ai_listing_rewrite` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:15758 `ai_seller_audit` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:16331 `ai_price_check` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:16645 `ai_yield_calc` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:16880 `ai_batch_card_listings` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:17143 `_classify_email` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:18074 `grade_card_condition` — ceiling ✓ spend-log ✓
- 🟠 **WARN** — bea_main.py:18831 `_ts_breaker_heartbeat` — spend-log ✓ but NO _check_cost_ceiling
- 🔴 **CRITICAL** — bea_main.py:18894 `planner_heritage_compose` — UNWRAPPED & UNMETERED Anthropic call (no ceiling, no spend log, no Tuppence)
- 🟠 **WARN** — bea_main.py:18832 `_hb_loop` — spend-log ✓ but NO _check_cost_ceiling
...
- ℹ️ **INFO** — MarketSquare/bea_main.py:15619 model constant `PRICE_CHECK_MODEL` = claude-sonnet-4-6 — used by Tuppence-metered endpoints; keep justified
...
- 🟠 **WARN** — MarketSquare/scripts/regression_ledger.py:3274 unknown model family `claude-fable-5` — classify
...
## Paid call-site inventory (144 hits)
...
- **Google APIs** (16): `MarketSquare/bea_main.py:12418`, `MarketSquare/bea_main.py:12419`, `MarketSquare/bea_main.py:14275`, `MarketSquare/citylauncher_ops.html:717`, `CityLauncher/citylauncher_launch.html:1052`, `CityLauncher/CITYLAUNCHER_REDESIGN.html:50`, `CityLauncher/api/server.py:172`, `CityLauncher/dashboard/citylauncher.html:899`, `CityLauncher/scraper/sources/google_maps.py:14`, `CityLauncher/scraper/sources/google_maps.py:185`, `CityLauncher/scraper/sources/google_maps.py:218`, `CityLauncher/scraper/sources/google_maps.py:495` …
- **OpenAI** (40): `MarketSquare/add_openai_key.bat:10`, `MarketSquare/add_openai_key.bat:11`, `MarketSquare/add_openai_key.bat:11`, `MarketSquare/add_openai_key.bat:13`, `MarketSquare/AI_BASELINE.json:428`, `MarketSquare/ai_provider.py:59`, `MarketSquare/ai_provider.py:149`, `MarketSquare/ai_provider.py:161`, `MarketSquare/ai_provider.py:261`, `MarketSquare/bea_main.py:14297`, `MarketSquare/bea_main.py:14430`, `MarketSquare/bea_main.py:14441` …
...
- **Paystack (txn)** (3): `MarketSquare/bea_main.py:14194`, `MarketSquare/payments.py:32`, `MarketSquare/subscription_monitor.py:157`
