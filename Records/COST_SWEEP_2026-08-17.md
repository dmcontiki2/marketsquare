# Cost-Compliance Sweep — 2026-08-17
_Principles: P1 $0-first · P2 budget every call · P3 independence/hot-swap. Sweep is static + $0; scanned 7 repos under `/sessions/great-blissful-cray/mnt/Projects`._

## Wrapper compliance — every AI call ceiling-checked + spend-logged (P2)

- ✅ **OK** — bea_main.py:3860 `_vision_orient_image` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:5817 `aa_market_note` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:5930 `listing_draft_from_photos` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:5999 `listing_draft_from_photo` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:6095 `aa_coach` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:9725 `trust_score_guidance` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:9981 `trust_score_upload_comment` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:10638 `_sonnet_verify_identity` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:12538 `_anon_ai_rewrite` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:14681 `vision_draft` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:15176 `ai_listing_rewrite` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:15265 `ai_seller_audit` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:15838 `ai_price_check` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:16152 `ai_yield_calc` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:16387 `ai_batch_card_listings` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:16650 `_classify_email` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:17581 `grade_card_condition` — ceiling ✓ spend-log ✓
- 🟠 **WARN** — bea_main.py:18336 `_ts_breaker_heartbeat` — spend-log ✓ but NO _check_cost_ceiling
- 🔴 **CRITICAL** — bea_main.py:18399 `planner_heritage_compose` — UNWRAPPED & UNMETERED Anthropic call (no ceiling, no spend log, no Tuppence)
- 🟠 **WARN** — bea_main.py:18337 `_hb_loop` — spend-log ✓ but NO _check_cost_ceiling
...
- ℹ️ **INFO** — MarketSquare/bea_main.py:1567 Sonnet in the provider-model registry (TASK_MODEL/fallback) — single-source, Tuppence-metered; keep justified
- ℹ️ **INFO** — MarketSquare/bea_main.py:15126 model constant `PRICE_CHECK_MODEL` = claude-sonnet-4-6 — used by Tuppence-metered endpoints; keep justified
...
- 🟠 **WARN** — MarketSquare/DEFENCE_COVERAGE_MAP.html:31 unknown model family `claude-fable-5` — classify
- 🟠 **WARN** — MarketSquare/DEFENCE_COVERAGE_MAP.html:93 unknown model family `claude-fable-5` — classify
...
- 🟠 **WARN** — MarketSquare/DAILY_WATCH/OPEN_ITEMS.json:400 unknown model family `claude-fable-5` — classify
...
- **Google APIs** (14): `MarketSquare/bea_main.py:13782`, `MarketSquare/citylauncher_ops.html:717`, `CityLauncher/citylauncher_launch.html:1052`, `CityLauncher/CITYLAUNCHER_REDESIGN.html:50`, `CityLauncher/api/server.py:172`, `CityLauncher/dashboard/citylauncher.html:899`, `CityLauncher/scraper/sources/google_maps.py:14`, `CityLauncher/scraper/sources/google_maps.py:185`, `CityLauncher/scraper/sources/google_maps.py:218`, `CityLauncher/scraper/sources/google_maps.py:495`, `CityLauncher/scraper/sources/google_maps.py:501`, `CityLauncher/scraper/sources/property24.py:320` …
- **OpenAI** (40): `MarketSquare/add_openai_key.bat:10`, `MarketSquare/add_openai_key.bat:11`, `MarketSquare/add_openai_key.bat:11`, `MarketSquare/add_openai_key.bat:13`, `MarketSquare/AI_BASELINE.json:428`, `MarketSquare/ai_provider.py:59`, `MarketSquare/ai_provider.py:149`, `MarketSquare/ai_provider.py:161`, `MarketSquare/ai_provider.py:261`, `MarketSquare/bea_main.py:13804`, `MarketSquare/bea_main.py:13937`, `MarketSquare/bea_main.py:13948` …
...
- **Paystack (txn)** (3): `MarketSquare/bea_main.py:13701`, `MarketSquare/payments.py:32`, `MarketSquare/subscription_monitor.py:157`

**Totals:** 3 critical · 16 warnings · 24 ok · 28 info
