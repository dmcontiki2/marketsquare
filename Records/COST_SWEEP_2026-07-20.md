# Cost-Compliance Sweep — 2026-07-20
_Principles: P1 $0-first · P2 budget every call · P3 independence/hot-swap. Sweep is static + $0; scanned 7 repos under `/sessions/cool-laughing-planck/mnt/Projects`._

## Wrapper compliance — every AI call ceiling-checked + spend-logged (P2)

- ✅ **OK** — bea_main.py:3121 `_vision_orient_image` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:4506 `aa_market_note` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:4618 `listing_draft_from_photos` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:4686 `listing_draft_from_photo` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:4781 `aa_coach` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:8346 `trust_score_guidance` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:8596 `trust_score_upload_comment` — ceiling ✓ spend-log ✓
- 🟠 **WARN** — bea_main.py:9140 `_sonnet_verify_identity` — helper; caller logs spend, but add a ceiling check
- 🟠 **WARN** — bea_main.py:10685 `_anon_ai_rewrite` — helper; caller logs spend, but add a ceiling check
- ✅ **OK** — bea_main.py:12360 `vision_draft` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:12819 `ai_listing_rewrite` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:12901 `ai_seller_audit` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:13410 `ai_price_check` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:13721 `ai_yield_calc` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:13951 `ai_batch_card_listings` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:14211 `_classify_email` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:14639 `grade_card_condition` — ceiling ✓ spend-log ✓
...
- ℹ️ **INFO** — MarketSquare/bea_main.py:12769 model constant `PRICE_CHECK_MODEL` = claude-sonnet-4-6 — used by Tuppence-metered endpoints; keep justified
...
- **Anthropic API** (14): `MarketSquare/ai_provider.py:74`, `MarketSquare/ai_provider.py:75`, `MarketSquare/bea_main.py:1279`, `MarketSquare/bea_main.py:1291`, `MarketSquare/failover/ai_backends.py:13`, `MarketSquare/failover/ai_backends.py:142`, `MarketSquare/failover/ai_backends.py:144`, `MarketSquare/main.py:1014`, `MarketSquare/main.py:1024`, `MarketSquare/subscription_monitor.py:122`, `AdvertAgent/run_video_reports.py:37`, `AdvertAgent/run_video_reports.py:125` …
...
- **Google APIs** (13): `MarketSquare/citylauncher_ops.html:717`, `CityLauncher/api/server.py:172`, `CityLauncher/citylauncher_launch.html:1052`, `CityLauncher/CITYLAUNCHER_REDESIGN.html:50`, `CityLauncher/dashboard/citylauncher.html:899`, `CityLauncher/scraper/sources/google_maps.py:14`, `CityLauncher/scraper/sources/google_maps.py:185`, `CityLauncher/scraper/sources/google_maps.py:218`, `CityLauncher/scraper/sources/google_maps.py:495`, `CityLauncher/scraper/sources/google_maps.py:501`, `CityLauncher/scraper/sources/property24.py:320`, `CityLauncher/scraper/sources/property24.py:331` …
- **OpenAI** (13): `MarketSquare/add_openai_key.bat:19`, `MarketSquare/ai_provider.py:47`, `MarketSquare/ai_provider.py:113`, `MarketSquare/ai_provider.py:118`, `MarketSquare/bea_main.py:1280`, `MarketSquare/bea_main.py:1288`, `MarketSquare/bea_main.py:11698`, `MarketSquare/bea_main.py:11709`, `MarketSquare/main.py:1015`, `MarketSquare/main.py:1022`, `MarketSquare/main.py:9190`, `MarketSquare/subscription_monitor.py:123` …
