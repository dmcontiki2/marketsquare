# Cost-Compliance Sweep — 2026-07-03
_Principles: P1 $0-first · P2 budget every call · P3 independence/hot-swap. Sweep is static + $0; scanned 7 repos under `/sessions/friendly-fervent-wright/mnt/Projects`._
...
- ✅ **OK** — bea_main.py:9806 `vision_draft` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:10240 `ai_listing_rewrite` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:10330 `ai_seller_audit` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:10786 `ai_price_check` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:11105 `ai_yield_calc` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:11343 `ai_batch_card_listings` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:11588 `_classify_email` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:12024 `grade_card_condition` — ceiling ✓ spend-log ✓
...
- ℹ️ **INFO** — MarketSquare/bea_main.py:9625 model constant `VISION_MODEL` = claude-sonnet-4-6 — used by Tuppence-metered endpoints; keep justified
- ℹ️ **INFO** — MarketSquare/bea_main.py:10190 model constant `PRICE_CHECK_MODEL` = claude-sonnet-4-6 — used by Tuppence-metered endpoints; keep justified
...
- **OpenAI** (8): `MarketSquare/ai_provider.py:74`, `MarketSquare/ai_provider.py:79`, `MarketSquare/bea_main.py:1015`, `MarketSquare/bea_main.py:1022`, `MarketSquare/bea_main.py:9201`, `MarketSquare/main.py:1015`, `MarketSquare/main.py:1022`, `MarketSquare/main.py:9190`
