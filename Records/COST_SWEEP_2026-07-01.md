# Cost-Compliance Sweep — 2026-07-01
_Principles: P1 $0-first · P2 budget every call · P3 independence/hot-swap. Sweep is static + $0; scanned 7 repos under `/sessions/exciting-sweet-johnson/mnt/Projects`._

## Wrapper compliance — every AI call ceiling-checked + spend-logged (P2)

- ✅ **OK** — bea_main.py:2485 `_vision_orient_image` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:3858 `listing_draft_from_photos` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:3930 `listing_draft_from_photo` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:4029 `aa_coach` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:7194 `trust_score_guidance` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:7451 `trust_score_upload_comment` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:9795 `vision_draft` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:10229 `ai_listing_rewrite` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:10319 `ai_seller_audit` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:10775 `ai_price_check` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:11094 `ai_yield_calc` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:11332 `ai_batch_card_listings` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:11577 `_classify_email` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:12013 `grade_card_condition` — ceiling ✓ spend-log ✓
- ✅ **OK** — advert_agent.py:681 `run_model` — metered via Tuppence hold/settle
...
- ℹ️ **INFO** — MarketSquare/bea_main.py:9614 model constant `VISION_MODEL` = claude-sonnet-4-6 — used by Tuppence-metered endpoints; keep justified
- ℹ️ **INFO** — MarketSquare/bea_main.py:10179 model constant `PRICE_CHECK_MODEL` = claude-sonnet-4-6 — used by Tuppence-metered endpoints; keep justified
...
- ℹ️ **INFO** — AdvertAgent/service/advert_agent.py:237 Sonnet — allowed: paid Level-2, Tuppence-metered
- ℹ️ **INFO** — AdvertAgent/service/advert_agent.py:287 Sonnet — allowed: paid Level-2, Tuppence-metered
- ℹ️ **INFO** — AdvertAgent/service/advert_agent.py:332 Sonnet — allowed: paid Level-2, Tuppence-metered
- ℹ️ **INFO** — AdvertAgent/service/advert_agent.py:366 Sonnet — allowed: paid Level-2, Tuppence-metered
- ℹ️ **INFO** — AdvertAgent/service/advert_agent.py:453 Sonnet — allowed: paid Level-2, Tuppence-metered
- ℹ️ **INFO** — AdvertAgent/service/advert_agent.py:487 Sonnet — allowed: paid Level-2, Tuppence-metered
- ℹ️ **INFO** — AdvertAgent/service/advert_agent.py:522 Sonnet — allowed: paid Level-2, Tuppence-metered
- ℹ️ **INFO** — AdvertAgent/service/advert_agent.py:584 Sonnet — allowed: paid Level-2, Tuppence-metered
...
## Paid call-site inventory (101 hits)

- **Anthropic API** (13): `MarketSquare/bea_main.py:1014`, `MarketSquare/bea_main.py:1024`, `MarketSquare/main.py:1014`, `MarketSquare/main.py:1024`, `MarketSquare/ai_provider.py:38`, `MarketSquare/ai_provider.py:39`, `MarketSquare/failover/ai_backends.py:13`, `MarketSquare/failover/ai_backends.py:142`, `MarketSquare/failover/ai_backends.py:144`, `AdvertAgent/run_video_reports.py:37`, `AdvertAgent/run_video_reports.py:125`, `AdvertAgent/service/advert_agent.py:29` …
- **Anthropic SDK** (6): `MarketSquare/bea_main.py:8028`, `MarketSquare/data_audit.py:154`, `MarketSquare/main.py:8028`, `CityLauncher/emailer/emailer.py:99`, `CityLauncher/orchestration/strategist_agent.py:301`, `CityLauncher/orchestration/haiko_agent.py:228`
...
- **OpenAI** (8): `MarketSquare/bea_main.py:1015`, `MarketSquare/bea_main.py:1022`, `MarketSquare/bea_main.py:9190`, `MarketSquare/main.py:1015`, `MarketSquare/main.py:1022`, `MarketSquare/main.py:9190`, `MarketSquare/ai_provider.py:74`, `MarketSquare/ai_provider.py:79`
- **Paid data feeds** (60): `MarketSquare/test_ai_service_tiers.py:6`, `MarketSquare/test_ai_service_tiers.py:53`, `MarketSquare/test_ai_service_tiers.py:55`, `MarketSquare/test_ai_service_tiers.py:56`, `MarketSquare/test_ai_service_tiers.py:60`, `MarketSquare/ai_service_tiers.py:19`, `MarketSquare/ai_service_tiers.py:104`, `MarketSquare/ai_service_tiers.py:105`, `MarketSquare/ai_service_tiers.py:107`, `MarketSquare/ai_service_tiers.py:192`, `MarketSquare/ai_service_tiers.py:193`, `MarketSquare/ai_service_tiers.py:200` …
- **Paystack (txn)** (1): `MarketSquare/payments.py:32`

**Totals:** 0 critical · 0 warnings · 21 ok · 29 info
