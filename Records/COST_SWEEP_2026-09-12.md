# Cost-Compliance Sweep — 2026-09-12
_Principles: P1 $0-first · P2 budget every call · P3 independence/hot-swap. Sweep is static + $0; scanned 7 repos under `/sessions/ecstatic-dazzling-davinci/mnt/Projects`._
...
- ✅ **OK** — bea_main.py:10954 `trust_score_guidance` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:11217 `trust_score_upload_comment` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:11874 `_sonnet_verify_identity` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:14969 `_anon_ai_rewrite` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:17680 `vision_draft` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:18180 `ai_listing_rewrite` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:18269 `ai_seller_audit` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:18849 `ai_price_check` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:19163 `ai_yield_calc` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:19398 `ai_batch_card_listings` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:19781 `_classify_email` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:21187 `grade_card_condition` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:22237 `_ts_breaker_heartbeat` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:22309 `planner_heritage_compose` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:22238 `_hb_loop` — ceiling ✓ spend-log ✓
...
- ℹ️ **INFO** — MarketSquare/bea_main.py:18130 model constant `PRICE_CHECK_MODEL` = claude-sonnet-4-6 — used by Tuppence-metered endpoints; keep justified
- 🟠 **WARN** — MarketSquare/boards_host.bat:4 unknown model family `claude-code` — classify
- ℹ️ **INFO** — MarketSquare/dashboard.server.html:1410 model name inside a UI display label — text on a diagram, not a call site (DW-009)
...
- ℹ️ **INFO** — MarketSquare/scripts/regression_ledger.py:16312 Fable (claude-fable-5) in reference text — not a call site (DW-047)
- 🟠 **WARN** — MarketSquare/scripts/regression_ledger.py:20584 unknown model family `claude-code` — classify
...
- **Paystack (txn)** (11): `MarketSquare/bea_main.py:12870`, `MarketSquare/bea_main.py:12880`, `MarketSquare/bea_main.py:12884`, `MarketSquare/bea_main.py:12887`, `MarketSquare/bea_main.py:12891`, `MarketSquare/bea_main.py:16440`, `MarketSquare/payments.py:32`, `MarketSquare/subscription_monitor.py:157`, `MarketSquare/scripts/audit_env_file.sh:8`, `MarketSquare/scripts/fix_paystack_env.py:71`, `MarketSquare/scripts/verify_paystack_key.sh:17`
