# Cost-Compliance Sweep — 2026-08-09
_Principles: P1 $0-first · P2 budget every call · P3 independence/hot-swap. Sweep is static + $0; scanned 7 repos under `/sessions/zealous-vigilant-pascal/mnt/Projects`._

## Wrapper compliance — every AI call ceiling-checked + spend-logged (P2)

- ✅ **OK** — bea_main.py:3624 `_vision_orient_image` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:5577 `aa_market_note` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:5689 `listing_draft_from_photos` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:5757 `listing_draft_from_photo` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:5852 `aa_coach` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:9478 `trust_score_guidance` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:9733 `trust_score_upload_comment` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:10387 `_sonnet_verify_identity` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:12124 `_anon_ai_rewrite` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:14184 `vision_draft` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:14636 `ai_listing_rewrite` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:14724 `ai_seller_audit` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:15296 `ai_price_check` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:15609 `ai_yield_calc` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:15841 `ai_batch_card_listings` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:16103 `_classify_email` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:16980 `grade_card_condition` — ceiling ✓ spend-log ✓
- 🟠 **WARN** — bea_main.py:17734 `_ts_breaker_heartbeat` — spend-log ✓ but NO _check_cost_ceiling
- 🟠 **WARN** — bea_main.py:17735 `_hb_loop` — spend-log ✓ but NO _check_cost_ceiling
...
- ℹ️ **INFO** — MarketSquare/bea_main.py:14586 model constant `PRICE_CHECK_MODEL` = claude-sonnet-4-6 — used by Tuppence-metered endpoints; keep justified
...
- **Google APIs** (14): `MarketSquare/bea_main.py:13331`, `MarketSquare/citylauncher_ops.html:717`, `CityLauncher/citylauncher_launch.html:1052`, `CityLauncher/CITYLAUNCHER_REDESIGN.html:50`, `CityLauncher/api/server.py:172`, `CityLauncher/dashboard/citylauncher.html:899`, `CityLauncher/scraper/sources/google_maps.py:14`, `CityLauncher/scraper/sources/google_maps.py:185`, `CityLauncher/scraper/sources/google_maps.py:218`, `CityLauncher/scraper/sources/google_maps.py:495`, `CityLauncher/scraper/sources/google_maps.py:501`, `CityLauncher/scraper/sources/property24.py:320` …
- **OpenAI** (31): `MarketSquare/add_openai_key.bat:10`, `MarketSquare/add_openai_key.bat:11`, `MarketSquare/add_openai_key.bat:11`, `MarketSquare/add_openai_key.bat:13`, `MarketSquare/ai_provider.py:50`, `MarketSquare/ai_provider.py:138`, `MarketSquare/ai_provider.py:150`, `MarketSquare/ai_provider.py:204`, `MarketSquare/bea_main.py:13353`, `MarketSquare/bea_main.py:13485`, `MarketSquare/bea_main.py:13496`, `MarketSquare/bea_main.py:14203` …
...
- **Paystack (txn)** (3): `MarketSquare/bea_main.py:13250`, `MarketSquare/payments.py:32`, `MarketSquare/subscription_monitor.py:157`
