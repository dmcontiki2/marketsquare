# Cost-Compliance Sweep — 2026-09-02
_Principles: P1 $0-first · P2 budget every call · P3 independence/hot-swap. Sweep is static + $0; scanned 7 repos under `/sessions/brave-zealous-cannon/mnt/Projects`._
...
- ✅ **OK** — bea_main.py:16764 `vision_draft` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:17259 `ai_listing_rewrite` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:17348 `ai_seller_audit` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:17928 `ai_price_check` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:18242 `ai_yield_calc` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:18477 `ai_batch_card_listings` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:18832 `_classify_email` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:19953 `grade_card_condition` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:20773 `_ts_breaker_heartbeat` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:20845 `planner_heritage_compose` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:20774 `_hb_loop` — ceiling ✓ spend-log ✓
...
- ℹ️ **INFO** — MarketSquare/bea_main.py:17209 model constant `PRICE_CHECK_MODEL` = claude-sonnet-4-6 — used by Tuppence-metered endpoints; keep justified
...
- **Google APIs** (17): `MarketSquare/ai_provider.py:226`, `MarketSquare/bea_main.py:13711`, `MarketSquare/bea_main.py:13712`, `MarketSquare/bea_main.py:15865`, `MarketSquare/citylauncher_ops.html:727`, `CityLauncher/citylauncher_launch.html:1089`, `CityLauncher/CITYLAUNCHER_REDESIGN.html:50`, `CityLauncher/api/server.py:243`, `CityLauncher/dashboard/citylauncher.html:927`, `CityLauncher/scraper/sources/google_maps.py:14`, `CityLauncher/scraper/sources/google_maps.py:217`, `CityLauncher/scraper/sources/google_maps.py:250` …
- **OpenAI** (41): `MarketSquare/add_openai_key.bat:10`, `MarketSquare/add_openai_key.bat:11`, `MarketSquare/add_openai_key.bat:11`, `MarketSquare/add_openai_key.bat:13`, `MarketSquare/AI_BASELINE.json:442`, `MarketSquare/ai_provider.py:59`, `MarketSquare/ai_provider.py:156`, `MarketSquare/ai_provider.py:168`, `MarketSquare/ai_provider.py:292`, `MarketSquare/bea_main.py:15887`, `MarketSquare/bea_main.py:16020`, `MarketSquare/bea_main.py:16031` …
