# Cost-Compliance Sweep — 2026-09-04
_Principles: P1 $0-first · P2 budget every call · P3 independence/hot-swap. Sweep is static + $0; scanned 7 repos under `/sessions/amazing-intelligent-wozniak/mnt/Projects`._
...
- 🟠 **WARN** — MarketSquare/scripts/regression_ledger.py:14168 unknown model family `claude-relay` — classify
- 🟠 **WARN** — MarketSquare/scripts/regression_ledger.py:14168 unknown model family `claude-relay` — classify
...
- **Anthropic SDK** (5): `MarketSquare/data_audit.py:154`, `MarketSquare/main.py:8028`, `CityLauncher/emailer/emailer.py:147`, `CityLauncher/orchestration/haiko_agent.py:228`, `CityLauncher/orchestration/strategist_agent.py:301`
...
**Totals:** 0 critical · 5 warnings · 28 ok · 40 info
