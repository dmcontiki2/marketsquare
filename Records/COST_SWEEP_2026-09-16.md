# Cost-Compliance Sweep — 2026-09-16
_Principles: P1 $0-first · P2 budget every call · P3 independence/hot-swap. Sweep is static + $0; scanned 7 repos under `/sessions/awesome-laughing-hypatia/mnt/Projects`._

## Wrapper compliance — every AI call ceiling-checked + spend-logged (P2)

- ✅ **OK** — bea_main.py:4358 `_vision_orient_image` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:7160 `aa_market_note` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:7273 `listing_draft_from_photos` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:7342 `listing_draft_from_photo` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:7438 `aa_coach` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:7762 `aa_coach_ask` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:11507 `trust_score_guidance` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:11858 `trust_score_upload_comment` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:12527 `_sonnet_verify_identity` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:15866 `_anon_ai_rewrite` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:18577 `vision_draft` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:19077 `ai_listing_rewrite` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:19166 `ai_seller_audit` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:19746 `ai_price_check` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:20060 `ai_yield_calc` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:20295 `ai_batch_card_listings` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:20682 `_classify_email` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:22090 `grade_card_condition` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:23524 `_ts_breaker_heartbeat` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:23596 `planner_heritage_compose` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:23525 `_hb_loop` — ceiling ✓ spend-log ✓
...
- ℹ️ **INFO** — MarketSquare/bea_main.py:1805 Sonnet in the provider-model registry (TASK_MODEL/fallback) — single-source, Tuppence-metered; keep justified
- ℹ️ **INFO** — MarketSquare/bea_main.py:19027 model constant `PRICE_CHECK_MODEL` = claude-sonnet-4-6 — used by Tuppence-metered endpoints; keep justified
- 🟠 **WARN** — MarketSquare/boards_host.bat:4 unknown model family `claude-code` — classify
- ℹ️ **INFO** — MarketSquare/dashboard.server.html:1480 model name inside a UI display label — text on a diagram, not a call site (DW-009)
...
- 🟠 **WARN** — MarketSquare/scripts/regression_ledger.py:21071 unknown model family `claude-code` — classify
...
## Paid call-site inventory (168 hits)
...
- **Google APIs** (17): `MarketSquare/ai_provider.py:231`, `MarketSquare/bea_main.py:15099`, `MarketSquare/bea_main.py:15100`, `MarketSquare/bea_main.py:17561`, `MarketSquare/citylauncher_ops.html:727`, `CityLauncher/citylauncher_launch.html:1089`, `CityLauncher/CITYLAUNCHER_REDESIGN.html:50`, `CityLauncher/api/server.py:451`, `CityLauncher/dashboard/citylauncher.html:928`, `CityLauncher/scraper/sources/google_maps.py:14`, `CityLauncher/scraper/sources/google_maps.py:217`, `CityLauncher/scraper/sources/google_maps.py:250` …
- **OpenAI** (50): `MarketSquare/add_openai_key.bat:10`, `MarketSquare/add_openai_key.bat:11`, `MarketSquare/add_openai_key.bat:11`, `MarketSquare/add_openai_key.bat:13`, `MarketSquare/AI_BASELINE.json:442`, `MarketSquare/ai_provider.py:64`, `MarketSquare/ai_provider.py:161`, `MarketSquare/ai_provider.py:173`, `MarketSquare/ai_provider.py:297`, `MarketSquare/bea_main.py:17583`, `MarketSquare/bea_main.py:17716`, `MarketSquare/bea_main.py:17727` …
...
- **Paystack (txn)** (11): `MarketSquare/bea_main.py:13534`, `MarketSquare/bea_main.py:13544`, `MarketSquare/bea_main.py:13548`, `MarketSquare/bea_main.py:13551`, `MarketSquare/bea_main.py:13555`, `MarketSquare/bea_main.py:17337`, `MarketSquare/payments.py:32`, `MarketSquare/subscription_monitor.py:157`, `MarketSquare/scripts/audit_env_file.sh:8`, `MarketSquare/scripts/fix_paystack_env.py:71`, `MarketSquare/scripts/verify_paystack_key.sh:17`

**Totals:** 0 critical · 8 warnings · 28 ok · 49 info
