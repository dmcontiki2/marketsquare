# Cost-Compliance Sweep — 2026-07-26
_Principles: P1 $0-first · P2 budget every call · P3 independence/hot-swap. Sweep is static + $0; scanned 7 repos under `/sessions/affectionate-relaxed-bohr/mnt/Projects`._
...
- ✅ **OK** — bea_main.py:4826 `aa_market_note` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:4938 `listing_draft_from_photos` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:5006 `listing_draft_from_photo` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:5101 `aa_coach` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:8682 `trust_score_guidance` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:8932 `trust_score_upload_comment` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:9476 `_sonnet_verify_identity` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:11131 `_anon_ai_rewrite` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:12939 `vision_draft` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:13398 `ai_listing_rewrite` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:13480 `ai_seller_audit` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:14048 `ai_price_check` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:14359 `ai_yield_calc` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:14589 `ai_batch_card_listings` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:14849 `_classify_email` — ceiling ✓ spend-log ✓
- ✅ **OK** — bea_main.py:15277 `grade_card_condition` — ceiling ✓ spend-log ✓
...
- ℹ️ **INFO** — MarketSquare/bea_main.py:13348 model constant `PRICE_CHECK_MODEL` = claude-sonnet-4-6 — used by Tuppence-metered endpoints; keep justified
...
- **Anthropic API** (14): `MarketSquare/ai_provider.py:74`, `MarketSquare/ai_provider.py:75`, `MarketSquare/bea_main.py:1316`, `MarketSquare/bea_main.py:1328`, `MarketSquare/main.py:1014`, `MarketSquare/main.py:1024`, `MarketSquare/subscription_monitor.py:122`, `MarketSquare/failover/ai_backends.py:13`, `MarketSquare/failover/ai_backends.py:142`, `MarketSquare/failover/ai_backends.py:144`, `AdvertAgent/run_video_reports.py:37`, `AdvertAgent/run_video_reports.py:125` …
...
- **OpenAI** (13): `MarketSquare/add_openai_key.bat:19`, `MarketSquare/ai_provider.py:47`, `MarketSquare/ai_provider.py:113`, `MarketSquare/ai_provider.py:118`, `MarketSquare/bea_main.py:1317`, `MarketSquare/bea_main.py:1325`, `MarketSquare/bea_main.py:12277`, `MarketSquare/bea_main.py:12288`, `MarketSquare/main.py:1015`, `MarketSquare/main.py:1022`, `MarketSquare/main.py:9190`, `MarketSquare/subscription_monitor.py:123` …
...
- **Paystack (txn)** (3): `MarketSquare/bea_main.py:12150`, `MarketSquare/payments.py:32`, `MarketSquare/subscription_monitor.py:157`
