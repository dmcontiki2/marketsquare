...
_Updated: 2 August 2026 · Owner: David._
...
| **EULA** | **v1.12** | **PUBLISHED** (v1.11 live 1 Aug; v1.12 on disk 2 Aug, ships next deploy — pre-counsel per David's standing instruction; A6 counsel review remains OPEN) | **Yes** | v1.9 = live web fork (v1.3 lineage, which had drifted ahead of the docx: FICA deferred-KYC, Tuppence expiry, Casuals roles, AI 2T/3T/5T) + new: §2.6 not-a-referral, §8.10 Reference Library, §13.5 local-laws, §13.6 Country Schedules UK/US/AU. Shipped: terms.html + embedded copy in marketsquare.html gate. NOTE: docx lineage (v1.7→v1.8→v1.9 drafts in repo) and web fork MUST be consolidated by counsel — two forks exist. Last fully-Final = v1.4. v1.10/v1.11 (SS6.1A affiliate disclosure, lifecycle clauses) and v1.12 (SS6.1B Partner Content, 2 Aug) continued the web lineage — all ride the A6 consolidation. |
