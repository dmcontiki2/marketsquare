# Global QA audit — 2026-08-30 (17.0s)
...
- **INFO** [drift] `VERSION-KEY-BENIGN` — repo html pins ms.js v477, live pins v551, but the served bytes are IDENTICAL to the repo — this is the server's monotonic ?v= bump, not drift. Recorded, not raised (DW-001).
