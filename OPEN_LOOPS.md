...
| D10 | **Privacy copy for the tester fault intake** — the form now collects name, email, page URL, browser details and optional screenshots. In-form notice is live; privacy.html has no clause for it. Draft is in `PRIVACY_FAULT_INTAKE_DRAFT.md`. | [D] | Approve the wording (or amend), then Claude lands it in privacy.html — required before the flag opens beyond testers at launch. | 2026-08-05 | CCP Gate 1 |
