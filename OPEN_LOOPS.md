...
| L19 | **25 Sep inspection of both apps: 274 of 283 items fixed and live (deploys 25 Sep 21:10, 26 Sep 09:56 and 10:58, and a small third one 26 Sep for AI search + the green-tick wording); every item's closure note is on `INSPECTION_2026-09-25_CLOSURES.html`.** Verified on the live site with writes faked (36 items walked; Quick in all four languages; every changed file byte-identical to the tested build); ledger from David's PC 466/489 holding, 0 new red; six new entries RG-0495..0502 guard the fixes. Kept by design after appeal: per-city counts, Quick's 'who am I', 'pass Quick on'. Open: five choices for David (Terms edits langt-01/27 need a version bump and his sign-off; banking cards langt-06; one word 'listing' or 'advert' langt-21; Quick's unused Services pictures vs RG-0487 quick-20) and qa-11 — CityLauncher's mint_agency_console_link must send X-Admin-Key (its emailer.py holds another lane's uncommitted QUICK-LINK-1 work), then drop "local": true on POST /agencies/wave-prep. | [D] / [C] | David: the five choices (put to him 26 Sep). CityLauncher lane: qa-11 exactly as written in the closures file. | 2026-09-26 | INSPECTION_2026-09-25_CLOSURES.html · changelog.d/2026-09-26-inspection-fix-wave.md · changelog.d/2026-09-26-inspection-languages-carried.md |
