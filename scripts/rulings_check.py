...
REFLECTIONS = {
 ...
 # --- Role-slate sitting 1, 19 Sep 2026: clearance gates visibility for three child/dependent-adult
 # roles. Asserted on the slate itself, because the slate is the canonical state of that review.
 "RUL-153": [
   ("RULINGS.md", ["A POLICE CLEARANCE IS WHAT OPENS PUBLIC VISIBILITY, NOT A BONUS"], []),
   ("ROLE_SLATE_REVIEW.md", ["| Nanny |  | IN |", "| Caregiver |  | IN |", "| Cr\u00e8che assistant |  | IN |",
                            "Police clearance gates public visibility (RUL-153)"],
                           ["Nanny / childminder |"]),
 ],
 "RUL-154": [
   ("RULINGS.md", ["NO ROLE IS LOST BY BEING DEFERRED"], []),
   ("ROLE_SLATE_REVIEW.md", ["## LATER / HOLD / ROUTED REGISTER (RUL-154)", "### LATER \u2014 after beta",
                            "### HOLD \u2014 blocked on a legal registration", "### ROUTED \u2014 not a service role, but not dropped"], []),
 ],
 "RUL-155": [
   ("RULINGS.md", ["EVERY DRIVING ROLE IS LISTED AT ONCE BUT PUBLICLY VISIBLE ONLY WHEN ITS LEGAL LICENCE IS VERIFIED"], []),
   ("ROLE_SLATE_REVIEW.md", ["| Driver | D | IN |", "| Code 10 / Code 14 driver |  | IN |", "Licence gate (RUL-155)", "PrDP-G"], []),
 ],
 "RUL-156": [
   ("RULINGS.md", ["THE RUL-155 GATE COVERS EVERY LICENCE TO PRACTISE"], []),
   ("ROLE_SLATE_REVIEW.md", ["| Security guard |  | IN |", "| Car guard |  | IN |", "| Taxi / shuttle driver |  | IN |",
                            "| Electrician |  | IN |", "| Gas installer |  | IN |"], ["| Security guard |  | HOLD |"]),
 ],
 "RUL-157": [
