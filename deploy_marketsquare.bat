...
::  Copies latest HTML files to Hetzner server and reloads nginx
...
echo  [1/3] Deploying buyer app (marketsquare.html -> index.html)...
...
echo  [2/3] Deploying admin tool (marketsquare_admin.html -> admin.html)...
...
:: ── Step 3: Reload nginx ─────────────────────────────────
echo  [3/3] Reloading nginx on server...
