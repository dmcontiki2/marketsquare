...
| AU-SELLER | **OPEN** — auction-seller eligibility (skin in the game): trust-score floor (Quick ~75 / Std ~80 / Prem ~88 / Regal ~92) + subscription floor (Quick ≥ Standard $12 · Std ≥ Professional $20 · Prem-Regal ≥ Business $40; Regal consider ≥ Elite). Reduces (not eliminates) seller flop; verification ladder + escrow + EULA do the rest. Open knob: Free-tier into Quick via higher trust or a per-auction Tuppence burn. | Design | ATTENDED |
