...
c.drawString(32*mm,59*mm,'Join early: listed, verified and positioned before the first buyer walks in.')
...
c.drawString(150*mm,300*mm,'Early agencies are positioned first — verified, scored, visible.')
