...
_CATEGORY_SIGNALS = {
    ...
    "local_market": {
        ...
        "category.lm.assoc_role_2":        {"name": "Second named association role (national + provincial structures)", "points": 10, "declaration_points": 8, "evidence_points": 2, "how_to_earn": "Declare a second named role in a different structure of your field (e.g. national secretary AND provincial committee member) — 8 pts immediately; upload the appointment letter for the final 2 pts.", "evidence_required": True, "additional_to": "category.lm.assoc_role", "declaration_prompt": "Describe your second role, organisation, and appointment date."},
