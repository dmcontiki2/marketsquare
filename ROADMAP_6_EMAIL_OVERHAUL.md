...
- ✅ **AI guidance = FREE in-app; advanced AI features are Tuppence-priced per use. (The old "1 Tuppence for 8 coaching sessions" is RETIRED, David 6 Jun 2026 — no template may reference AI uses/sessions.)** Consistent across templates. Leave the pricing as a variable-friendly phrase so a cost-model change is a one-string edit, not a nine-file hunt.
