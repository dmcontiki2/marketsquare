...
- ONE-TAP-PUBLISH-1: `POST /quick/publish` creates the advert, records the terms accepted by the tap, and publishes it in one call; a signed-in member publishes as her session; slot limit, velocity and price-basis guards stand; a "your advert is live" letter carries her way back.
