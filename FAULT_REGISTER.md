...
| LIST-003 | 2026-08-06 | David (tester) | Duplicate/near-identical photo in an advert's set (TS-0006; recurred 15 Aug as TS-0034; David's advert = listing 268 garden service, photos 1≈3 human-identical though hash read 123/256 — plus listing 267 electrician, hash 30/256) | 2 | CLOSED 15 Aug (letter sent) | BOTH swapped 15 Aug (267: switch-install render; 268: same-garden jacaranda-raking render), same filenames, origin-verified 200, CDN purged. Dedupe-design lesson: human-identical scenes can hash >100/256 — eyeball outranks the hash. Class-level dedupe detection remains the Path B backlog item from TS-0006 |
