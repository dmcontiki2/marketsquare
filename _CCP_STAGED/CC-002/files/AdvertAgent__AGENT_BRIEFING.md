...
| **Wallet display** | "Tuppence balance · used for introductions" | "AI feature credits · not used for introductions" |

**Mandatory UI copy rules (AdvertAgent screens only):**

| Context | Forbidden ❌ | Required ✅ |
|---|---|---|
| Pack purchase button | RETIRED — packs gone (Canon Addendum 1); advanced AI is per-use | — |
| Wallet AI card title | "AI Credits" | "AI feature credits" |
...
| Stage 3 zero-balance CTA | RETIRED — packs gone | "Top up Tuppence — advanced AI is priced per use" |
